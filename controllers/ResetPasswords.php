...
class ResetPasswords{
    ...
    public function __construct(){
        ...
        $this->mail->Port = 2525;
        $this->mail->Username = '996c380fe9d1b6';
        $this->mail->Password = 'e9287ec23ac27a';
    }
    ...
    public function sendEmail(){
        ...
        $url = 'http://127.0.0.1/LOGIN-SYSTEM-YT/create-new-password.php?selector='.$selector.'&validator='.bin2hex($token);
